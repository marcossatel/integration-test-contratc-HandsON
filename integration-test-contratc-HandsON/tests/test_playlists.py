...
class Playlists(unittest.TestCase):
    ...
    def test_get_playlists(self):
        response = self.request.playlists_get(self.access_token, "me")
    ...
    def test_create_new_playlist(self):
        body = {
                "name": "teste copntrats1",
                "public": "false",
                "collaborative": "false",
                "description": "esta playlist é para teste no hands ON"
                }

        response = self.request.playlist_create(self.access_token, "12158312048", body)
